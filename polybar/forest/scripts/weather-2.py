...
# Settings
city = "Santiago, CL" # Your town
api_key = "4cf3731a25d1d1f4e4a00207afd451a2" # Your openweather api key
...
def main():
    try:
        ...
        if(result.status_code == requests.codes['ok']):
                ...
                return '%{F#FFFF00}' + icons_list[icon] + '%{F#C4C7C5}' + ' {}°{}'.format(temp, temperature_unit) + '%{F-}'
        else:
