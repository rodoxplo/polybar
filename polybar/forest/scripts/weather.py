...
#REQ = requests.get("http://api.openweathermap.org/data/2.5/".format(CITY, LANG,  API_KEY, UNITS))
REQ = requests.get("http://api.openweathermap.org/data/2.5/weather?q={}&units={}&appid={}".format(city, units, api_key))
